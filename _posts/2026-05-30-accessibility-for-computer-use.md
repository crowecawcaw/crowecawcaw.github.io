...
This post covers the xa11y design decisions which navigate these challenges.

## Cross-platform differences
Every platform has accessibility APIs that are conceptually similar at a high level: desktop UIs are represented by trees of elements which have various properties and which can accept updates and actions. Up close though, the APIs diverge.
